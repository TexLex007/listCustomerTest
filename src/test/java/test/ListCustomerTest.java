...
public class ListCustomerTest {
	WebDriver driver;
	@Test
	public void userShouldBeAddedInCustomerList() throws EncryptedDocumentException, IOException, InterruptedException {
		...
		listCustomerPage.verifyCustomerIsAddedAndDelete(AddCustomerPage.getInsertedEmail());
